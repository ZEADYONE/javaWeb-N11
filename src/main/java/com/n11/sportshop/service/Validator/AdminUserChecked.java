...
// gọi đến class "AdminUserValidator.class"
...
public @interface AdminUserChecked {
    // @interface là từ khóa để tạo một annotation mới.
    // public giúp annotation có thể được sử dụng ở bất kỳ đâu trong project.
    // AdminUserChecked là tên của annotation.
    String message() default "Admin user creation validation failed";
